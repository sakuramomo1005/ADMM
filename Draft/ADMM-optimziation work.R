...
update_vz = function(lambda_1, lambda_2, gamma_1, gamma_2, nu1,
                     nu2, w_l, u_k, 
                     al1, al2, ak1, ak2){
...
vz = update_vz(lambda_1, lambda_2, gamma_1, gamma_2, nu1,
          nu2, w_l, u_k, 
          al1, al2, ak1, ak2)
v = vz[[1]]; z = vz[[2]]

update_lambda = function(lambda_1,lambda_2,v, z, nu1,nu2, al1, al2, ak1, ak2){
...
bi_ADMM1=function(X, nu1, nu2, lambda_1, lambda_2, v, z, gamma_1, gamma_2, niter = 100000, imax = 0.1){
  ...
  for(iter in 1: niter){
    ...
    lambda = update_lambda(lambda_1,lambda_2,v, z, nu1,nu2, al1, al2, ak1, ak2)
...
fit3 = bi_ADMM1(X, nu1, nu2, lambda_1, lambda_2, v, z, gamma_1, gamma_2)